...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        console.log("New file added to firebase with ID:", docRef.id);
        ...
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                ...
                sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
                    ...
                    >
                        <div className='inline-block align-bottom bg-white rounded-lg px-4 pt-4 pb-4 text-left
                             focus:overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle 
                            ...
                            <div>
                                ...
                                <div className='mt-5 sm:mt-6'>
                                    <button
                                        ...
                                        hover:bg-red-700 focus:outline-none focus:ring-1 focus:ring-offset-2
